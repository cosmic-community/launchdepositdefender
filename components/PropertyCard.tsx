  ...
  if (showDeleteConfirm) {
    return (
      <Card className="relative">
        <div className="absolute inset-0 bg-white/95 backdrop-blur-sm rounded-xl flex items-center justify-center p-6">
    ...
    <Card className="hover:shadow-lg transition-all duration-300 group relative overflow-hidden">
      <CardHeader className="pb-3">
        <div className="flex items-start justify-between">
          ...
          <Button
            ...
            onClick={handleDelete}
            disabled={isDeleting}
            className="opacity-0 group-hover:opacity-100 transition-opacity hover:bg-danger-50 hover:text-danger-600"
          >
      ...
      <CardContent className="space-y-4">
        ...
        <div>
          ...
          <Progress value={property.overallProgress} className="mb-3" />
          ...
          <div className="space-y-2">
            {property.rooms.slice(0, 3).map((room) => (
              <div key={room.id} className="flex items-center justify-between">
                ...
                <div className="flex items-center space-x-2">
                  <Progress value={room.progressPercentage} className="w-16 h-1.5" />
      ...
      <CardFooter className="flex-col space-y-3">
        ...
        {/* Metadata */}
        <div className="flex items-center justify-between text-xs text-gray-500 w-full pt-2 border-t">
